Instance: IVR-VS-procAirType
InstanceOf: $shareablevalueset
Usage: #definition
* meta.source = "http://art-decor.org/fhir/ValueSet/2.16.756.5.30.1.1.11.43--20170408121354"
* extension.url = "http://hl7.org/fhir/StructureDefinition/resource-effectivePeriod"
* extension.valuePeriod.start = "2017-04-08T12:13:54+02:00"
* url = "http://fhir.ch/ig/ch-ems/ValueSet/IVR-VS-procAirType"
* identifier.use = #official
* identifier.system = "http://art-decor.org/ns/oids/vs"
* identifier.value = "2.16.756.5.30.1.1.11.43"
* version = "2017-04-08T12:13:54"
* name = "IVRVSprocAirType"
* title = "IVR valueset procedure airway type (.143.11.40)"
* status = #draft
* experimental = false
* publisher = "Interverband für Rettungswesen"
* description = "IVR valueset procedure airway type (.143.11.40)"
* immutable = false
...
* compose.include.concept[=].designation[0].language = #de-CH
* compose.include.concept[=].designation[=].value = "Esmarch Handgriff"
* compose.include.concept[=].designation[+].language = #fr-CH
