...
Usage: #definition
* meta.source = "http://art-decor.org/fhir/ValueSet/2.16.756.5.30.1.1.11.23--20161113155040"
* extension.url = "http://hl7.org/fhir/StructureDefinition/resource-effectivePeriod"
* extension.valuePeriod.start = "2016-11-13T15:50:40+02:00"
* url = "http://fhir.ch/ig/ch-ems/ValueSet/IVR-VS-event"
* identifier.use = #official
* identifier.system = "http://art-decor.org/ns/oids/vs"
* identifier.value = "2.16.756.5.30.1.1.11.23"
* version = "2016-11-13T15:50:40"
* name = "IVRVSevent"
* title = "IVR valueset event (.143.11.15)"
* status = #draft
* experimental = false
* publisher = "Interverband für Rettungswesen"
* description = "IVR valueset event (.143.11.15)"
* immutable = false
