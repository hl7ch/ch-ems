...
* author[0].reference = "PractitionerRole/1-SaniPetraMuster-PR" 
    ...
    <table>
        <tbody>
            <tr>
                ...
                <th>Abfahrtszeit vom Zielort: </th>
                <th>Zeit Einsatzbereit: </th>
            </tr>
            <tr>
                <th>12:09</th>
                <th>12:11</th>
...
* section[anamnesis].entry[medicationStatement] = Reference(1-AspirinCardio)
...
* section[procedures].entry[medicationAdministration][+] = Reference(1-Spray)
