...
* extension[=].valueIdentifier.value = "urn:uuid:662e3c16-0aac-11e8-ba89-0ed5f89f718b"
...
* subject.reference = "Patient/2-PatientUnbekannt" // CDA: recordTarget
...
* author[=].extension.valueDateTime = "2016-12-10T12:40:00.000+01:00"
...
* section[mission].entry[missionTimeStatus][+] = Reference(2b-DepartureFromTarget)
